...
MODEL_REGISTRY: dict[str, ModelSpec] = {
    ...
    "openrouter/meta-llama/llama-3.1-8b-instruct": ModelSpec(
    ...
    "openrouter/meta-llama/llama-3.3-70b-instruct": ModelSpec(
    ...
    "openrouter/deepseek/deepseek-chat": ModelSpec(
